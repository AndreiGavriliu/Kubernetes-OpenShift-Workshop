...
- [Cert-Kubernetes Download Page](https://www.ibm.com/support/pages/node/6576423)
- [Planning Production Deployment](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=planning-production-deployment)
- [Installing using PDF Guides](https://www.ibm.com/docs/en/cloud-paks/cp-biz-automation/26.0.0?topic=installing-using-pdf-guides-install-single-capability-pattern)
